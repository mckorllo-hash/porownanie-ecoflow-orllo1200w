    ...
    <div className="container relative z-10 mx-auto px-4 py-16 md:py-24">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        className="rounded-2xl border-2 border-primary/30 surface-elevated p-6 text-center glow-primary relative">
          ...
          <img alt="Przenośna stacja zasilania ORLLO 1200W 1024Wh LiFePO4" className="w-full max-w-[280px] mx-auto rounded-xl mb-4" src="/lovable-uploads/305be210-33e1-4654-8db3-2900fbb339ca.jpg" />
