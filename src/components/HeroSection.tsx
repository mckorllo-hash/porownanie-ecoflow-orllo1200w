    ...
    <div className="container relative z-10 mx-auto px-4 py-16 md:py-24">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        className="rounded-2xl border border-border surface-elevated p-6 text-center">
          ...
          <img alt="EcoFlow River 2 Pro stacja zasilania" className="w-full max-w-[280px] mx-auto rounded-xl mb-4 opacity-70" src="/lovable-uploads/27f36cc7-8c85-492f-9646-7b1de28c1f77.jpg" />
